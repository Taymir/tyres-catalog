...
<table align="center" bgcolor="#EEEEEE" cellpadding="5" style="border: 1px solid #999999" width="620">
    <caption align="top">
        <h2>Импорт списка производителей </h2>
        </caption>
    <tr>
    ...
    <tr>
        <td width="70%" align="center"><img src="images/xls_manfrs.png" border="1"></td>
    </tr>
    <tr>
        <td><fieldset><legend>Подсказка</legend>
            ...
            <br>
            <b>Столбец "Категория" может содержать только одно из трех значений: tyres (производитель шин), disks (Производитель дисков), both (Производитель шин и дисков)!</b>
            <br>
            Если в базе уже имеются данные с теми параметрами, которые вы импортируете, то обновлены они не будут!
        </fieldset>
            </td>
    </tr>
    <tr>
