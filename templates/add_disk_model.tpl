...
<table align="center" bgcolor="#EEEEEE" cellpadding="5" style="border: 1px solid #999999" width="620">
    <caption align="top">
        <h2>Добавление / изменение моделей дисков </h2>
    ...
    <tr>
        ...
        <td>
            <select name="material">
                <!-- BEGIN: material --><!-- BEGIN: option --><option value="{id}" <!-- BEGIN: chosen -->selected="selected"<!-- END: chosen -->>{value}</option><!-- END: option --><!-- END: material -->
            </select>
        </td>
    </tr>
    <tr>
