...
<table align="center" bgcolor="#EEEEEE" cellpadding="5" style="border: 1px solid #999999" width="620">
    <caption align="top">
        <h2>Импорт прайс-листа дисков </h2>
        </caption>
    <tr>
    ...
    <tr>
        <td width="70%" align="center"><img src="images/xls_disks.png" border="1"></td>
    </tr>
    <tr>
        <td><fieldset><legend>Подсказка</legend>
            ...
            <br>
            <br>
            Если в базе уже имеются данные с теми параметрами, которые вы импортируете, то для них будут обновлены цены. 
        </fieldset>
            </td>
    </tr>
    <tr>
